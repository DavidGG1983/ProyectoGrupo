...
public class DisparoAvion extends Modelo {

    private double aceleracionY = 2;

    public DisparoAvion(Context context, double x, double y) {
        super(context, x, y, 12, 5);
        imagen = CargadorGraficos.cargarDrawable(context, R.drawable.disparoavion);
    }
